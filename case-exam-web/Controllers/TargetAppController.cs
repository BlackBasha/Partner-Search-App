...
namespace case_exam_web.Controllers
{
    public class TargetAppController : Controller
    {
        ...
        private IOfficeService _targetAppService;
        private readonly IMapper _mapper;
        private IAppLogService _appLogService;
        private INotifier<Message> _emailNotifier;

        public TargetAppController(IOfficeService targetAppService, IMapper mapper, IAppLogService appLogService, INotifier<Message> emailNotifier)
        {
